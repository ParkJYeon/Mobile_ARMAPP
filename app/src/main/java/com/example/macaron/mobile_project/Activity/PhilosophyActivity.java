...
public class PhilosophyActivity extends FragmentActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.drawer_philosophy_layout);
    ...
    protected void onResume() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    boolean is_read = dbModule.executeRawQuery_Read("철학", knewledge.gettitle());
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                adapter.notifyDataSetChanged();
                if(!dbModule.executeRawQuery_Read("철학", knewledges.get(position).gettitle())) {
                    dbModule.insert_Read("철학", knewledges.get(position).gettitle());
                }

                ChangeModule changeModule = new ChangeModule();
                changeModule.chActi(PhilosophyActivity.this, KnewledgeActivity.class, "지식", "철학", knewledges.get(position).gettitle(), knewledges.get(position).getcontent());
    ...
    public void clickMenuPhilo(View view){
        DrawerLayout drawer = (DrawerLayout)findViewById(R.id.drawer_philosophy_layout);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        Activity preActivity = PhilosophyActivity.this;
        Class curActivity = PhilosophyActivity.class;
