...
public class HistoryActivity extends FragmentActivity implements NavigationView.OnNavigationItemSelectedListener{
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.drawer_history_layout);
    ...
    public void clickMenuHis(View view){
        DrawerLayout drawer = (DrawerLayout)findViewById(R.id.drawer_history_layout);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        Activity preActivity = HistoryActivity.this;
        Class curActivity = HistoryActivity.class;
