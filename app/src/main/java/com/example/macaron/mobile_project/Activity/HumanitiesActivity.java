...
public class HumanitiesActivity extends FragmentActivity implements NavigationView.OnNavigationItemSelectedListener{
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.drawer_humanities_layout);
    ...
    public void clickMenuHum(View view){
        DrawerLayout drawer = (DrawerLayout)findViewById(R.id.drawer_humanities_layout);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        Activity preActivity = HumanitiesActivity.this;
        Class curActivity = HumanitiesActivity.class;
